...
parser.add_argument('--root_path', type=str, default='../CBCT_DATA/', help='Name of Experiment')  # todo change dataset path
parser.add_argument('--model', type=str,  default="U+R+CPS_1", help='model_name')                # todo change test model name
